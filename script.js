...
function draw() {
    ...
    if (!isVisualizerEnabled) { canvasCtx.clearRect(0, 0, canvas.width, canvas.height); return; }
...
function clearPlaylist() { playlist = []; player.pause(); player.src = ""; renderPlaylist(); }